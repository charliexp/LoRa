				...
				if (RadioRxBuffer[TARGET_ADDRESS] == DEVICE_ADDRESS)
				{
					switch (RadioRxBuffer[COMMAND_CODE])
					{
						...
						case COMMAND_RX_SYM_TIMEOUT:
							...
							break;
						case COMMAND_RX_MS_TIMEOUT:
							PRINTF("Rx Timeout (ms): %u\n\r", (uint32_t) RadioRxBuffer[COMMAND_PARAMETER - 3] << 24 |
																								(uint32_t) RadioRxBuffer[COMMAND_PARAMETER - 2] << 16 |
																								(uint32_t) RadioRxBuffer[COMMAND_PARAMETER - 1] << 8 |
																													 RadioRxBuffer[COMMAND_PARAMETER]);
							LoRa_RxMsTimeout = (uint32_t) RadioRxBuffer[COMMAND_PARAMETER - 3] << 24 |
																(uint32_t) RadioRxBuffer[COMMAND_PARAMETER - 2] << 16 |
																(uint32_t) RadioRxBuffer[COMMAND_PARAMETER - 1] << 8 |
																					 RadioRxBuffer[COMMAND_PARAMETER];
							RadioSetupRequired = 1;
						...
						case COMMAND_TX_TIMEOUT:
							PRINTF("Tx Timeout (ms): %u\n\r", (uint32_t) RadioRxBuffer[COMMAND_PARAMETER - 3] << 24 |
																								...
																								(uint32_t) RadioRxBuffer[COMMAND_PARAMETER - 1] << 8 |
																													 RadioRxBuffer[COMMAND_PARAMETER]);
							LoRa_TxTimeout = (uint32_t) RadioRxBuffer[COMMAND_PARAMETER - 3] << 24 |
															(uint32_t) RadioRxBuffer[COMMAND_PARAMETER - 2] << 16 |
															(uint32_t) RadioRxBuffer[COMMAND_PARAMETER - 1] << 8 |
																				 RadioRxBuffer[COMMAND_PARAMETER];
							RadioSetupRequired = 1;
